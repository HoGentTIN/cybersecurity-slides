...
Er worden hier enkele termen gebruikt:
SSL / TLS: Een encryptie-algoritme dat bijvoorbeeld gebruikt wordt in HTTPS (beveiligd surfen op het internet, zie H5),
SSH: Een manier om op een veilige manier vanop afstand in te loggen op toestel en deze te beheren alsof je er zelf ter plekke aan zit (zie het labo over SSH).
...
---
## Technieken
<img width="15%" src="./img/h4/eni.jpg" style="float:right" />
...
- De opkomst van **AI** kan mogelijks in de toekomst een grote rol spelen bij het kraken van encryptie, als AI modellen hiervoor getraind kunnen worden (bijvoorbeeld door training met vaak gebruikte wachtwoorden)
...
---
## Enkele tools
<img width="10%" src="./img/h4/john.png" style="float:right" />
...
<img width="10%" src="./img/h4/hc.png" style="float:right" />
...
---
## Steganografie
<img width="10%" src="./img/h4/steg.jpg" style="float:right" />
...
<center><img width="50%" src="./img/h4/obf.png" class="r-stretch" /></center>
Note:
...
<center><img width="80%" src="./img/h4/js_obf.png" class="r-stretch" /></center>
Note:
- Code Obfuscation kan heel nuttig zijn voor broncode die niet gecompileerd wordt, zoals bijvoorbeeld JavaScript of PHP (en de meeste interpreter-gebaseerde talen). Deze slide toont een voorbeeld van obfuscation van een eenvoudig stuk JavaScript code. Dit is geen fictief voorbeeld, de code rechts is werkende JavaScript code!
...
---
## Toegangscontrole
<img width="10%" src="./img/h4/tc.png" style="float:right" />
...
Toegangscontrole komt nog uitgebreid aan bod in **H7** van deze cursus
