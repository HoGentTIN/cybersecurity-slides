...
-   **MD5** en **SHA-1** zijn **zwakke algoritmes** waarbij botsingen bewust veroorzaakt kunnen worden
    https://csrc.nist.gov/projects/hash-functions - Praktisch voorbeeld: https://www.mscs.dal.ca/~selinger/md5collision/
...
| Gebruikersnaam | Paswoord |
|---|---|
| tom@gmail.com | EF92B778BAFE771E89245 |
| hanne@gmail.com | EF92B778BAFE771E89245 |

Hash + Salt: extra veilig

| Gebruikersnaam  | Salt              | Paswoord          |
| --------------- | ----------------- | ----------------- |
| tom@gmail.com   | D;%yL9TS:5PalS/d  | 9C9B913EB1B6254F4 |
| hanne@gmail.com | )<,-<U(jLezy4j>\* | 6058B4EB46BD64872 |
...
-   Het opstellen van een rainbow table moet maar een keer gebeuren, je kan deze dus downloaden van het internet
...
Dit lijkt goed op digitale handtekeningen, maar bij digitale handtekeningen wordt asymetrische encryptie gebruikt (zie 5.1)
