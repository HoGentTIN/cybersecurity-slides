...
-   Iedereen kan een self signed certificate genereren
    ...
    -   Geeft vaak een foutmelding, test het zelf eens uit: https://self-signed.badssl.com
...
-   **Versleutelde verbinding** tussen jou en een ander netwerk
    -   Bv. work at home verbinding met servers op bedrijfsnetwerk
    -   "**tunnel**" tussen VPN client en VPN server
    -   Lijkt het alsof je rechtstreeks op dat ander netwerk
-   Vaak gebruikt voor **privacy** en tegen **geolocatie** restricties
